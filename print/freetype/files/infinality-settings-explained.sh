...
##################################################################
# From the Freetype 2.7.x adaptation
# (see https://github.com/archfan/infinality_bundle/blob/master/01_freetype2-iu/freetype2.sh)
#
...
#     truetype:interpreter-version=38  # (Old!) Infinality mode
