    ...
    configure {
        ...
        foreach arch ${universal_archs_to_use} {
            ...
            if { [info exists merger_configure_compiler($arch)] } {
                ...
                configure.cc        [portconfigure::configure_get_compiler cc $merger_configure_compiler($arch)]
                configure.cxx       [portconfigure::configure_get_compiler cxx $merger_configure_compiler($arch)]
                configure.objc      [portconfigure::configure_get_compiler objc $merger_configure_compiler($arch)]
                configure.f77       [portconfigure::configure_get_compiler f77 $merger_configure_compiler($arch)]
                configure.f90       [portconfigure::configure_get_compiler f90 $merger_configure_compiler($arch)]
                configure.fc        [portconfigure::configure_get_compiler fc $merger_configure_compiler($arch)]
            }
